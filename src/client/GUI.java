...
public class GUI extends JFrame {
				...
				Thread queryThread = new Thread() {
					public void run() {
						try {
							...
							JOptionPane.showMessageDialog(GUI.this, "Couldn't connect to the server", "Error",
	...
	/**
	 * Sets the mode label to the current mode.
	 * 
	 * @param mode
	 */
	...
	/**
	 * Sets the sync label to the current synchronization mode.
	 * 
	 * @param isSynced
	 */
	...
	/**
	 * Sets the auto label to the current auto mode.
	 * 
	 * @param isAuto
	 */
	...
	/**
	 * Notifies witch camera triggered motion. Updates the label accordingly.
	 * 
	 * @param index
	 */
	...
	/**
	 * Resets the motion triggered labels.
	 */
